...
app_publisher = "Indsys"
app_description = "A modern, secure visitor management app streamlines front-desk operations by replacing paper logs with digital check-ins, enhancing security through instant host notifications, photo capture, and badge printing"
